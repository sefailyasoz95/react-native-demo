...
type Props = {
  navigation: NativeStackNavigationProp<AppStackParams, 'SearchResultScreen'>;
  route: RouteProp<AppStackParams, 'SearchResultScreen'>;
};
...
const SearchResultScreen = ({navigation, route}: Props) => {
  ...
  useEffect(() => {
    dispatch(getMealsByName(route.params.searchValue));
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>
          Showing results for {`"${route.params.searchValue}"`}
        </Text>
        <View />
      </View>
